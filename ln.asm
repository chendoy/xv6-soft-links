...
main(int argc, char *argv[])
{
  ...
  21:	74 34                	je     57 <main+0x57>
    exit();
  23:	e8 da 02 00 00       	call   302 <exit>
    printf(2, "Usage (hard): ln old new\n");
  28:	51                   	push   %ecx
  29:	51                   	push   %ecx
  2a:	68 b8 07 00 00       	push   $0x7b8
  2f:	6a 02                	push   $0x2
  31:	e8 2a 04 00 00       	call   460 <printf>
    printf(2, "-OR-\n");
  36:	5b                   	pop    %ebx
  37:	58                   	pop    %eax
  38:	68 d2 07 00 00       	push   $0x7d2
  3d:	6a 02                	push   $0x2
  ...
  4d:	e8 0e 04 00 00       	call   460 <printf>
    exit();
  52:	e8 ab 02 00 00       	call   302 <exit>
    if(symlink(argv[2], argv[3]) < 0)
  57:	50                   	push   %eax
  58:	50                   	push   %eax
  59:	ff 73 0c             	pushl  0xc(%ebx)
  5c:	ff 73 08             	pushl  0x8(%ebx)
  5f:	e8 3e 03 00 00       	call   3a2 <symlink>
  64:	83 c4 10             	add    $0x10,%esp
  67:	85 c0                	test   %eax,%eax
  69:	79 b8                	jns    23 <main+0x23>
      printf(2, "symlink %s %s: failed\n", argv[1], argv[2]);
  6b:	ff 73 08             	pushl  0x8(%ebx)
  6e:	ff 73 04             	pushl  0x4(%ebx)
  71:	68 f1 07 00 00       	push   $0x7f1
  76:	6a 02                	push   $0x2
  78:	e8 e3 03 00 00       	call   460 <printf>
  7d:	83 c4 10             	add    $0x10,%esp
  80:	eb a1                	jmp    23 <main+0x23>
    if(link(argv[1], argv[2]) < 0)
  82:	52                   	push   %edx
  83:	52                   	push   %edx
  84:	ff 73 08             	pushl  0x8(%ebx)
  87:	ff 73 04             	pushl  0x4(%ebx)
  8a:	e8 d3 02 00 00       	call   362 <link>
  8f:	83 c4 10             	add    $0x10,%esp
  92:	85 c0                	test   %eax,%eax
  94:	79 8d                	jns    23 <main+0x23>
      printf(2, "hard link %s %s: failed\n", argv[1], argv[2]);
  96:	ff 73 08             	pushl  0x8(%ebx)
  99:	ff 73 04             	pushl  0x4(%ebx)
  9c:	68 d8 07 00 00       	push   $0x7d8
  a1:	6a 02                	push   $0x2
  a3:	e8 b8 03 00 00       	call   460 <printf>
  a8:	83 c4 10             	add    $0x10,%esp
  ab:	e9 73 ff ff ff       	jmp    23 <main+0x23>
 ...
 3c9:	85 d2                	test   %edx,%edx
{
 ...
 3f7:	f7 f1                	div    %ecx
 3f9:	0f b6 92 40 08 00 00 	movzbl 0x840(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
          s = "(null)";
 619:	bb 38 08 00 00       	mov    $0x838,%ebx
        while(*s != 0){
 ...
 631:	a1 e8 0a 00 00       	mov    0xae8,%eax
{
 ...
 66d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 66f:	a3 e8 0a 00 00       	mov    %eax,0xae8
}
 674:	5b                   	pop    %ebx
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 70f:	73 47                	jae    758 <malloc+0x98>
    ...
    if(p == freep)
 711:	39 05 e8 0a 00 00    	cmp    %eax,0xae8
 ...
 736:	e8 f5 fe ff ff       	call   630 <free>
  return freep;
 73b:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
 ...
 764:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 767:	89 15 e8 0a 00 00    	mov    %edx,0xae8
}
 ...
 787:	0a 00 00 
 78a:	c7 05 ec 0a 00 00 ec 	movl   $0xaec,0xaec
 791:	0a 00 00 
    base.s.size = 0;
 794:	b8 ec 0a 00 00       	mov    $0xaec,%eax
